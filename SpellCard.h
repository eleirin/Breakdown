 ...
 * explosions.
 *
 * Note also that update is final, as we want the child to only work during the explosions. \todo{Draw is as well for now, as there is no way to update the position smoothly, but it will eventually be only override}
